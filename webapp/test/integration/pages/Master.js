		...
		onTheMasterPage : {
			...
			actions : {
				...
				iRememberTheListItem : function (oListItem) {
					...
					this.getContext().currentItem = {
						...
						id: oBindingContext.getProperty("transportid"),
						title: oBindingContext.getProperty("transportid")
					};
				}
			},
			...
			assertions : {
				...
				theListShouldHaveAllEntries : function () {
					...
					// retrieve all ZTRANSPORT_ASS to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet : "ZTRANSPORT_ASS",
